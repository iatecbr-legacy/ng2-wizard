...
export class WizardComponent implements AfterContentInit {
     ...
     * ```
     */
    public addDisabledSteps(index: number): void {
     ...
     * ```
     */
    public removeDisabledSteps(index: number): void {
        if (this.inArray(this.defaults.disableSteps, index))
            return;
     ...
     * ```
     */
    public setDisabledSteps(indexs: Array<number>): void {
        if (typeof indexs != 'object')
            return;
