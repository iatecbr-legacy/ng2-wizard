import { Component, AfterContentInit, ElementRef, ContentChild, DoCheck } from '@angular/core';
...
export class WizardStepComponent implements AfterContentInit, DoCheck {
